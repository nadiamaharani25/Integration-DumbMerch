const { product, user, category, categoryproducks } = require("../../models");
...
exports.updateProduct = async (req, res) => {
  try {
    ...
    await categoryproducks.destroy({
      where: {
        idProduct: id,
      },
    });
    ...
    if (productCategoryData.length != 0) {
      await categoryproducks.bulkCreate(productCategoryData);
    }
